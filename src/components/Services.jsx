    ...
    <section className="section__container service__container">
      ...
      <div className="service__grid">
        ...
        <div className="service__card">
          ...
          <h4> 
          العرق الزائد في اليدين والقدمين 
          </h4>
          <p>
        ...
        <div className="service__card">
          ...
          الآلام المزمنة          </h4>
          <p>
          الآلام المزمنة هي آلام تستمر لفترة طويلة تتجاوز الفترة العادية المتوقعة للشفاء، وقد تكون نتيجة لحالات صحية مثل التهاب المفاصل، أمراض العصبية، آلام الظهر، أو حالات أخرى مثل الصداع النصفي وآلام الشوكة العظمية.          </p>
          <a href="#خدماتنا">تعرف أكثر</a>
        </div>
      </div>
    </section>
